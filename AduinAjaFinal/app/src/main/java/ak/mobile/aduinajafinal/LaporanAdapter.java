...
public class LaporanAdapter extends RecyclerView.Adapter {
    ...
    private class VH extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            intent.putExtra("pic", lapor.getPic());
            intent.putExtra("title", lapor.getTitle());
            intent.putExtra("kategori", lapor.getKategori());
            intent.putExtra("lokasi", lapor.getLokasi());
            intent.putExtra("kronologi", lapor.getKronologi()); // Baru
            intent.putExtra("detail", lapor.getDetail()); // Baru
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        int pic = ctx.getResources().getIdentifier(l.getPic(), "drawable", ctx.getPackageName());
        Glide.with(ctx)
                .load(pic)
                .placeholder(R.drawable.dompet) // Gambar placeholder
                .into(vh.pic);
